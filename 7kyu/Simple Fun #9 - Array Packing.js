...
const arrayPacking = (a) => {
  ...
  for (let i = a.length - 1; i >= 0; i--) {
    binaryStr += a[i].toString(2).padStart(8, '0');
  }
  return parseInt(binaryStr, 2);
};

// User solution that is a good refactor of mine:
...
// And yet another clever user solution:
const arrayPacking = (a) => a.reduceRight((pre, val) => pre * 256 + val, 0);
