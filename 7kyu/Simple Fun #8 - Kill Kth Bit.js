...
const killKthBit = (n, k) =>
  parseInt(
    [...n.toString(2)]
      .map((el, idx, arr) => (idx === arr.length - k ? 0 : el))
      .join(''),
    2
  );
...
/* Takeaways:
1) Remember, the String.prototype.replace function can accept a replacement function as its second parameter!
This replacement function is called for each match, and can include the element, index, and array.
*/
