...
// My one-liners:
const mirror = (data) => [...[...data].sort((a, b) => a - b), ...[...data].sort((a, b) => b - a).slice(1)];
const mirror = (data) => [...data].sort((a, b) => a - b).concat([...data].sort((a, b) => b - a).slice(1));

// My solution:
const mirror = (data) => {
  const ascending = [...data].sort((a, b) => a - b);
