...
// My solution:
const isFlush = (cards) => cards.slice(1).every((card) => card.slice(-1) === cards[0].slice(-1));

// Top user solution (though technically does an superfluous comparison, unlike mine!):
