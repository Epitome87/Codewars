...
// My solution (for some reason short-hand function notation was not working!):
...
const greetDevelopers = (list) =>
  list.map((dev) => ({ ...dev, greeting: `Hi ${dev.firstName}, what do you like the most about ${dev.language}?` }));
