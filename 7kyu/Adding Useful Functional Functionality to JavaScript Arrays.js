...
/* Takeaways:
1) Note that we cannot use something like this.slice(start, start + count) in the range function. This is because we are not adding it to the Array prototype, like we are with sum. 
Therefore we do not have access to the appropriate "this", or its slice method.
Thus we note an important distinction between adding a method on the Array itself and on the Array's prototype!
*/
