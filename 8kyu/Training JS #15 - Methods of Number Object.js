...
// My solution:
const howManySmaller = (arr, n) => arr.map((x) => x.toFixed(2)).reduce((acc, curr) => (curr < n ? acc + 1 : acc), 0);

// My other solution:
const howManySmaller = (arr, n) => arr.reduce((acc, curr) => (curr.toFixed(2) < n ? acc + 1 : acc), 0);
