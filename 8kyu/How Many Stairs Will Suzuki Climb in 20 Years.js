...
const stairsIn20 = (s) => {
  ...
  for (let i = 0; i < s.length; i++) {
    total += s[i].reduce((acc, curr) => acc + curr, 0);
  }
...
const stairsIn20 = (s) => s.reduce((sum, curr) => sum + curr.reduce((sum, curr) => sum + curr, 0), 0) * 20;

// My further-refactored solution, after utilizing the flat() method:
