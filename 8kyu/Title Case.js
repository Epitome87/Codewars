/*
96222588% of 3,13111,778 of 28,810user527539
JavaScript
...
const titleCase = (title, minorWords = '') => {
  ...
  const res = titleLowered.split(' ').map((word, index) => {
    if (minorLowered.includes(word) && index !== 0)
...
// "Clever" user solution (though I think modifying the String.prototype is bad practice!):
