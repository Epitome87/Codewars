...
const solution = (
  ...
  const R = 0.082;
  return (
    ((givenMass1 / molarMass1 + givenMass2 / molarMass2) * R * tempKelvin) /
    volume
  );
};

/* Takeaways:
1) I need to watch my parenthesis! What would make sense to use in math class seemed to not work here for some odd reason?!
*/
